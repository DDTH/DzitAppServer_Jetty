...
<div id="content-wrap">
	<div id="main">
		...
		<a href="http://jetty.codehaus.org/jetty/">Jetty</a>, customized for DDTH's applications.</p>
		...
		<h3>Jetty</h3>
		<ul>
			<li><a href="http://jetty.codehaus.org/jetty/"><%= org.eclipse.jetty.server.Server.getVersion() %></a></li>
		</ul>
		<%!
		...
		<%
		{
			...
			if (jettyHome != null) {
				File libDir = new File(jettyHome + "/lib");
				...
				out.println("<h3>Cannot find the JETTY_HOME</h3>");    		
			}
		}
		%>
