...
<div id="shutdownMemberDialog" class="resultDialog" title="Shutdown Member">
    <p><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span>Member is shutdown
        successfully.</p>
</div>

<div id="restartMemberDialog" class="resultDialog" title="Restart Member">
    <p><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span>Member is restarted
        successfully.</p>
</div>

<div id="shutdownMemberAskDialog" class="resultDialog" title="Shutdown Member">
    <p><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span>
        The member will be shutdown. Are you sure?
    </p>
</div>

<div id="restartMemberAskDialog" class="resultDialog" title="Restart Member">
    <p><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span>
        The member will be restarted. Are you sure?
    </p>
</div>
...
<div id="logLevelResultDialog" class="resultDialog"  title="Log Level Configured">
    <p><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span>Log level configured
        successfully. Press "Refresh" to reload logs.</p>
</div>
