...
rem set OPTS_DASP=-Ddasp.logs.home=%JETTY_HOME%\logs -Ddasp.data.home=%JETTY_HOME%\data\dasp -Dhazelcast.mancenter.home=%JETTY_HOME%\data\hazelcast -Dspring.profiles.active=dev
